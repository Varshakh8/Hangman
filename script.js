...
function startGame() {
  ...
  updateWordDisplay();
  document.getElementById("hangman-img").src = "images/hangman-0.png";
}
...
function handleGuess(letter, button) {
  ...
  if (selectedWord.includes(letter)) {
    ...
    attemptsDisplay.textContent = maxAttempts - wrongLetters.length;
    document.getElementById("hangman-img").src = `images/Hangman-${wrongLetters.length}.png`;
...
function checkLose() {
  if (wrongLetters.length >= maxAttempts) {
    ...
    updateWordDisplay(); // Reveal full word
    endGame();
  }
}
